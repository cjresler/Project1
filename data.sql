/*
	...
	*/
	...
	insert into flights values ('AC052','MOS','LAX',to_date('21:00', 'hh24:mi'),60);
	...
	insert into flight_fares values ('AC052','J',10,2000,2);
	insert into flight_fares values ('AC052','Y',20,700,0);
	insert into flight_fares values ('AC052','Q',10,500,0);
